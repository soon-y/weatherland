export async function fetchOpenMeteo(latitude, longitude, timezone) {
  ...
  const hourlyUrl = `${baseWeatherUrl}hourly=is_day,apparent_temperature,visibility,wind_gusts_10m,relative_humidity_2m,dew_point_2m,cloud_cover_low,precipitation,precipitation_probability,temperature_2m,rain,showers,snowfall,snow_depth,weather_code,wind_speed_10m,wind_direction_10m,pressure_msl&timezone=${timezone}`
